...
opts, args = getopt.getopt(sys.argv[1:],"c:d:f:g:G:L:v:",["code=','bin_dir=","bin_file=","gal_dir=","gal_file=","LISA_file=","variation="])
...
bp.point_plot(ZAMS.mass1,ZAMS.mass2,log_P,log_tau,mask,code+' @ZAMS points')
...
bp.point_plot(WDMS.mass1,WDMS.mass2,log_P,log_tau,mask,code+' @WDMS points')
...
bp.hexbin_plot(Galaxy.mass1,Galaxy.mass2,log_P,log_tau,code+' Galaxy {:,} sources'.format(int(N_candidates)),bins,colmap,Ngrid)
...
bp.hexbin_plot(LISA_Gal.mass1,LISA_Gal.mass2,log_P,log_tau,code+' Galaxy only {:,} LISA sources'.format(int(N_LISA)),bins,colmap,Ngrid)
